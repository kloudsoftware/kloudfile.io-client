...
public class Upload {
    ...
    public static String uploadDataToServer(InputStream in) {
        ...
        HttpEntity httpEntity = MultipartEntityBuilder.create().addBinaryBody("file", in, ContentType.create("application/octet-stream"), "file").addPart("key", keyBody).build();
